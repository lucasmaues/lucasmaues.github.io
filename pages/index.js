            ...
            <div class="container left special">
                ...
                <div class="col">
                    <div class="col-left">
                        ...
                        <p>Now I’m working at TCM-PA and making open source PWAs.</p>

                    </div>
                    <div class="col-right">
                        <p>I build user-first digital products with strong focus on refined front-end (responsive design, progressive enhancement, accessibility and performance) and adjacent back-end.</p>

                        <p>HTML, CSS, JavaScript, React, Next, Node, PHP, Git, Linux, AWS, Azure, Vercel, SQL and REST APIs are my main tools.</p>
                    </div>
